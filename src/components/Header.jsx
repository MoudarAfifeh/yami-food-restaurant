          ...
          <div className=" relative">
            ...
            {isMenu && (
              <motion.div
                ...
                className=" w-40 bg-gray-50 shadow-xl rounded-lg flex flex-col absolute top-12 right-0 px-4 py2"
              >
                {user && user.email === "moudarafifeh@gmail.com" && (
                  <Link to="/createItem">
                    <p
        ...
        <div className=" relative">
          ...
          {isMenu && (
            ...
            >
              ...
              <p
                className="m-2 p-2 rounded-md shadow-md flex items-center justify-center bg-gray-200 gap-3 cursor-pointer hover:bg-gray-300 transition-all duration-100  ease-in-out text-base text-textColor"
                onClick={logout}
              >
                Lougout <MdLogout />
              </p>
